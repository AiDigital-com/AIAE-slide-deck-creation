package com.aidigital.strategyplanning.error;

import com.aidigital.strategyplanning.api.v1.model.AppApiExceptionResponseV1;
import com.aidigital.strategyplanning.api.v1.model.AppValidationExceptionResponseV1;
import com.aidigital.strategyplanning.error.mapper.GlobalExceptionResponseHelper;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private static final String EXTERNAL_PREFIX = "C003";
	...
	public HttpStatus statusForCode(String code) {
		...
		if (code.startsWith(EXTERNAL_PREFIX)) {
