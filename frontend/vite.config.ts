...
export default defineConfig(({ mode }) => {
    ...
    return {
        ...
        test: {
            // Unmounts each render and registers jest-dom's matchers. Without it a
            // second component test in one file queries a DOM that still holds the
            // previous render. See src/test-setup.ts.
